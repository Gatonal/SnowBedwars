...
public final class ArenaManager {
    ...
    public boolean rejoin(Player player,Arena arena) { if(arena==null || byPlayer.containsKey(player.getUniqueId()) || !arena.getPlayers().contains(player.getUniqueId())) return false; byPlayer.put(player.getUniqueId(),arena); return true; }
